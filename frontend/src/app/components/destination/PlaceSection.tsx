...
export function PlaceSection({
  ...
  const handleCardClick = useCallback(
    (dest: DestinationCardDest, cardRect: DOMRect, renderId: string) => {
  ...
  return (
    <section className="w-full py-4 min-h-[200px]">
      <div className="w-full px-[15px] md:px-[50px]">
        <h2 className="flex items-center gap-1 text-lg md:text-xl font-bold text-gray-900 mb-6 md:mb-8 cursor-pointer hover:text-gray-600 transition-colors font-serif">
          {title}
        </h2>
